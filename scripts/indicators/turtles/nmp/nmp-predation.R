...
csv_rid <- "dbc63425-9904-4937-b5ee-0398ad610813"
pdf_rid <- "f521c927-a3e6-4267-bd92-01ac7a15a252"
txt_rid <- "1bd1618b-f0f0-47f1-9db4-f5873bb99328"

pdf_fn <- "nmp-predation.pdf"
txt_fn <- "nmp-predation.R"
...
out <- ggplot(d, aes(x=Year_number, y=Percent_predation)) +
  geom_line() +
  geom_point() + # 21 is filled circle
  geom_hline(aes(yintercept=d$Threshold)) +
  xlab("") +
