...
csv_rid <- "f820d7c7-e074-4f37-8e23-daed93495a45"
pdf_rid <- "20ab611d-f182-4a1f-b1ae-a0828e8f3d9e"
txt_rid <- "b76719d0-e7b0-40af-ab51-bb747b11b6a1"

pdf_fn <- "nmp-hawksbill-tracks.pdf"
txt_fn <- "nmp-hawksbill-tracks.R"
...
out <- ggplot(d, aes(x=Year_number, y=Hawksbill_tracks)) +
  geom_line() +
  geom_point() + # 21 is filled circle
  xlab("") +
  ylab("Average hawksbill turtle activity per subsection per day") +
