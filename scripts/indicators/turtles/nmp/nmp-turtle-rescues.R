...
csv_rid <- "6794a5f3-ef5e-405d-9dbe-e47cfd38043b"
pdf_rid <- "cbf8dd1d-4a80-47dc-9d77-0a9306ec9141"
txt_rid <- "02dd9b2f-e550-40c7-b063-68b8f37e533b"
...
out <- ggplot(d, aes(x=Year_number, y=Rescues)) +
  geom_line() +
