...
csv_rid <- "e92935f5-758e-4cb7-9224-b2568bc64f48"
pdf_rid <- "4c0587f0-eb93-414a-aa90-61e127916c8b"
txt_rid <- "a5a77eac-3951-45c5-bdc8-5d7887fd427b"

pdf_fn <- "nmp-green-nest-success.pdf"
txt_fn <- "nmp-green-nest-success.R"
...
out <- ggplot(d, aes(x=Year_number, y=Success_percent)) +
  geom_line() +
  geom_point() + # 21 is filled circle
  xlab("") +
  ylab("Green turtle nesting success %") +
