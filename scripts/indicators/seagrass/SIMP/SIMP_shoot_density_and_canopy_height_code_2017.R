...
SIMP_mean_height1 <- ddply(SIMP, .(Year),summarise,
...
#Canopy height
png(png_height_fn, width=800, height=300)
grid.arrange(SIMP_height_plot, SIMP_height_plot1, ncol = 2)
dev.off()

png(png_SIMP_height_fn, width=800, height=900)
...
ckanr::resource_update(png_SIMP_height_rid, png_SIMP_max_height_fn)
